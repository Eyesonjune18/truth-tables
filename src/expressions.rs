...
pub struct ExpressionElement {
    pub element: PropositionToken,
    pub negation: bool,
}

impl ExpressionElement {
    pub fn new(element: PropositionToken, negation: bool) -> Self {
        Self {
            element,
            negation,
        }
...
pub struct Expression {
    pub propositions: Vec<ExpressionElement>,
    pub operators: Vec<Operator>,
}

impl Expression {
    pub fn new(propositions: Vec<ExpressionElement>, operators: Vec<Operator>) -> Self {
        Self {
            propositions,
            operators,
        }
...
pub fn get_subexpression(expression: &str) -> String {
